Contributing to Atanapi Core
============================

The Atanapi Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/atanapi/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Atanapi Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Atanapi
Network Protocol consensus changes.

Whether a pull request is merged into Atanapi Core rests with the project merge
...
Patches that change Atanapi consensus rules are considerably more involved than
...
Where a patch set proposes to change the Atanapi consensus, it must have been
...
The review process is normally fairly responsive on the Atanapi Core repository, however
...
The project leader is the release manager for each Atanapi Core release.
