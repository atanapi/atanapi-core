...
* atanapi.conf: contains configuration settings for atanapid or atanapi-qt
* atanapid.pid: stores the process id of atanapid while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by atanapid or atanapi-qt
