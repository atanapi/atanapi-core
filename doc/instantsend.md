...
This mechanism has been integrated into Bitcore-Node-Atanapi which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/atanapi/insight-api-atanapi#web-socket-api](https://github.com/atanapi/insight-api-atanapi#web-socket-api)
* API: [https://github.com/atanapi/insight-api-atanapi#instantsend-transactions](https://github.com/atanapi/insight-api-atanapi#instantsend-transactions)
