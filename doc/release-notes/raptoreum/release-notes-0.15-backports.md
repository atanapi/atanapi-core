...
- [`595826ad6`](https://github.com/atanapi/atanapi/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/atanapi/atanapi/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`6ec77c0a7`](https://github.com/atanapi/atanapi/commit/6ec77c0a7) Merge #11131: rpc: Write authcookie atomically
...
- [`37250c02e`](https://github.com/atanapi/atanapi/commit/37250c02e) Merge #11150: [tests] Add getmininginfo test
...
- [`7662c0b79`](https://github.com/atanapi/atanapi/commit/7662c0b79) A couple of fixes
...
- [`93754f8d8`](https://github.com/atanapi/atanapi/commit/93754f8d8) Merge #10799: Prevent user from specifying conflicting parameters to fundrawtx
...
- [`1a0d52814`](https://github.com/atanapi/atanapi/commit/1a0d52814)  #10483 scripted-diff: Use the C++11 keyword nullptr to denote the pointer literal instead of the macro NULL
...
- [`a7ef22261`](https://github.com/atanapi/atanapi/commit/a7ef22261) Merge #10995: Fix resendwallettransactions assert failure if -walletbroadcast=0
...
- [`d6d462fd7`](https://github.com/atanapi/atanapi/commit/d6d462fd7) #10193 scripted-diff: Remove BOOST_REVERSE_FOREACH
...
- [`b14bd204c`](https://github.com/atanapi/atanapi/commit/b14bd204c) Merge #10819: Fix uninitialized atomic variables
...
- [`2708a7be0`](https://github.com/atanapi/atanapi/commit/2708a7be0) Merge #10612: The young person's guide to the test_framework
...
- [`0647ea656`](https://github.com/atanapi/atanapi/commit/0647ea656) Merge #10587: Net: Fix resource leak in ReadBinaryFile(...)
...
- [`6318ca636`](https://github.com/atanapi/atanapi/commit/6318ca636) insecure_rand() -> InsecureRandBits
...
- [`c7aa3723c`](https://github.com/atanapi/atanapi/commit/c7aa3723c) Merge #10323: Update to latest libsecp256k1 master
...
- [`64d4113e0`](https://github.com/atanapi/atanapi/commit/64d4113e0) Merge #10061: [net] Added SetSocketNoDelay() utility function
...
- [`65d0fbf3c`](https://github.com/atanapi/atanapi/commit/65d0fbf3c) Merge #10253: [test] Add test for getnetworkhashps
...
- [`74830ee2a`](https://github.com/atanapi/atanapi/commit/74830ee2a) adjust spork5 code in wallet.cpp
...
- [`131e94ef2`](https://github.com/atanapi/atanapi/commit/131e94ef2) Merge #10201: pass Consensus::Params& to functions in validation.cpp and make them static
...
- [`e451325d6`](https://github.com/atanapi/atanapi/commit/e451325d6) Merge #10186: Remove SYNC_TRANSACTION_NOT_IN_BLOCK magic number
...
- [`0b232fd1c`](https://github.com/atanapi/atanapi/commit/0b232fd1c) Merge #10208: [wallet] Rescan abortability
- [`55d1251ff`](https://github.com/atanapi/atanapi/commit/55d1251ff) Merge #9480: De-duplicate SignatureCacheHasher
- [`29194b1f5`](https://github.com/atanapi/atanapi/commit/29194b1f5) Backport Bitcoin#9424, Bitcoin#10123 and Bitcoin#10153 (#2918)
- [`15fa1873d`](https://github.com/atanapi/atanapi/commit/15fa1873d) Drop redundant imports and fix related code
- [`6f91144f2`](https://github.com/atanapi/atanapi/commit/6f91144f2) Fix p2p-fingerprint.py
- [`92fed9254`](https://github.com/atanapi/atanapi/commit/92fed9254) Fix and re-enable pruning.py
- [`bfeb5bca4`](https://github.com/atanapi/atanapi/commit/bfeb5bca4) fix txindex.py and add it to extended scripts
- [`c37008a45`](https://github.com/atanapi/atanapi/commit/c37008a45) update dip4-coinbasemerkalroots.py and llmq-is-cl-conflicts.py
- [`7fd979cc0`](https://github.com/atanapi/atanapi/commit/7fd979cc0) Merge #10114: [tests] sync_with_ping should assert that ping hasn't timed out
- [`4121daba2`](https://github.com/atanapi/atanapi/commit/4121daba2) Merge #10098: Make qt wallet test compatible with qt4
- [`cc06ef551`](https://github.com/atanapi/atanapi/commit/cc06ef551) Merge #10109: Remove SingleNodeConnCB
- [`94aa904c0`](https://github.com/atanapi/atanapi/commit/94aa904c0) Merge #10107: Remove unused variable. Remove accidental trailing semicolons in Python code
- [`404e244d1`](https://github.com/atanapi/atanapi/commit/404e244d1) Merge #10088: Trivial: move several relay options into the relay help group
- [`05cb5a058`](https://github.com/atanapi/atanapi/commit/05cb5a058) Merge #10108: ApproximateBestSubset should take inputs by reference, not value
- [`bfd63c179`](https://github.com/atanapi/atanapi/commit/bfd63c179) Merge #10076: [qa] combine_logs: Use ordered list for logfiles
- [`e57559a8d`](https://github.com/atanapi/atanapi/commit/e57559a8d) Merge #10096: Check that all test scripts in test/functional are being run
- [`c2258978b`](https://github.com/atanapi/atanapi/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
- [`6bb55d547`](https://github.com/atanapi/atanapi/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
- [`142b5cba0`](https://github.com/atanapi/atanapi/commit/142b5cba0) Merge #10073: Actually run assumevalid.py
- [`14001a3d9`](https://github.com/atanapi/atanapi/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
- [`120941793`](https://github.com/atanapi/atanapi/commit/120941793) Merge #10083: [QA] Renaming rawTx into rawtx
- [`1781c7a70`](https://github.com/atanapi/atanapi/commit/1781c7a70) Merge #10069: [QA] Fix typo in fundrawtransaction test
- [`379312931`](https://github.com/atanapi/atanapi/commit/379312931) Merge #9946: Fix build errors if spaces in path or parent directory
- [`ba20c9031`](https://github.com/atanapi/atanapi/commit/ba20c9031) Merge #10067: [trivial] Dead code removal
- [`ae05068c5`](https://github.com/atanapi/atanapi/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
- [`9f07f489d`](https://github.com/atanapi/atanapi/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
- [`96a5f5730`](https://github.com/atanapi/atanapi/commit/96a5f5730) Merge #9500: [Qt][RPC] Autocomplete commands for 'help' command in debug console
- [`07e0567dc`](https://github.com/atanapi/atanapi/commit/07e0567dc) Merge #9558: Clarify assumptions made about when BlockCheck is called
- [`2aa3f890d`](https://github.com/atanapi/atanapi/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/atanapi/atanapi/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/atanapi/atanapi/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/atanapi/atanapi/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/atanapi/atanapi/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/atanapi/atanapi/commit/67c735b15) s/bitcoin-config.h/atanapi-config.h/
- [`2f63322cd`](https://github.com/atanapi/atanapi/commit/2f63322cd) atanapiify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/atanapi/atanapi/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/atanapi/atanapi/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/atanapi/atanapi/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/atanapi/atanapi/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/atanapi/atanapi/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/atanapi/atanapi/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/atanapi/atanapi/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/atanapi/atanapi/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/atanapi/atanapi/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/atanapi/atanapi/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/atanapi/atanapi/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/atanapi/atanapi/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/atanapi/atanapi/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/atanapi/atanapi/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/atanapi/atanapi/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/atanapi/atanapi/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/atanapi/atanapi/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/atanapi/atanapi/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/atanapi/atanapi/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/atanapi/atanapi/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/atanapi/atanapi/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/atanapi/atanapi/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/atanapi/atanapi/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/atanapi/atanapi/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/atanapi/atanapi/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/atanapi/atanapi/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/atanapi/atanapi/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/atanapi/atanapi/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/atanapi/atanapi/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/atanapi/atanapi/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/atanapi/atanapi/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/atanapi/atanapi/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/atanapi/atanapi/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/atanapi/atanapi/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/atanapi/atanapi/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/atanapi/atanapi/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/atanapi/atanapi/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/atanapi/atanapi/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/atanapi/atanapi/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/atanapi/atanapi/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/atanapi/atanapi/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/atanapi/atanapi/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/atanapi/atanapi/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/atanapi/atanapi/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/atanapi/atanapi/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/atanapi/atanapi/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/atanapi/atanapi/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/atanapi/atanapi/commit/1cfda206a) Merge #9993: Initialize nRelockTime
