...
rm -f src/config/atanapi-config.h
...
rm -rf test_bitcoin.coverage/ atanapi-gtest.coverage/ total.coverage/
...
clean_exe src/atanapi-cli
clean_exe src/atanapid
clean_exe src/atanapi-gtest
clean_exe src/atanapi-tx
clean_exe src/test/test_atanapi
clean_exe src/test/test_atanapi_fuzzy
...
clean_dep . src/config/atanapi-config.h.in
