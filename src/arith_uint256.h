...
#ifndef ATANAPI_ARITH_UINT256_H
#define ATANAPI_ARITH_UINT256_H
...
public:
     ...
     *
     * Atanapi only uses this "compact" format for encoding difficulty
