...
//! Interface for the src/evo part of a atanapi node (atanapid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a atanapi node (atanapid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a atanapi node (atanapid process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a atanapi node (atanapid process).
class Node
{
public:
    virtual ~Node() {}
