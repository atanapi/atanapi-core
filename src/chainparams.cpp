...
{
    const char* pszTimestamp = "ATANAPI: tomorrow is better than yesterday: Genesis Release 13/10/2022";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 200000; // Atanapi block halving
        consensus.nSmartnodePaymentsStartBlock = 5000; // Atanapi Smartnode block start
        ...
        consensus.nPowTargetSpacing = 2 * 60; // Atanapi: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0xb8e28f8da2e6a01572a6aa4267f453b95819d04248409cdf19c6057cc42164c7"); // 0
        ...
        //FindMainNetGenesisBlock(1665648066, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1665648066, 4043, 0x20001fff, 4, 5000 * COIN);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x23, 0x53, 0x54, 0x1E};
        // Atanapi BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x12, 0x55, 0xAE, 0x4B};
        ...
        vSporkAddresses = {"AZkC7XuQnjH8ikPzEvYdAhXzUHxCVrfdaf"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
          {  {0, uint256S("0xb8e28f8da2e6a01572a6aa4267f453b95819d04248409cdf19c6057cc42164c7")} }
	};

        chainTxData = ChainTxData{
          1665648066,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xf5f2b1c333bf4fb6ca0f3d304629389bf44dfb5740431c83c3f1cf97b98a4556"); // 0
        ...
        //FindMainNetGenesisBlock(1665648084,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1665648084, 1321, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf5f2b1c333bf4fb6ca0f3d304629389bf44dfb5740431c83c3f1cf97b98a4556"));
        assert(genesis.hashMerkleRoot == uint256S("0x4698315ac6eb3404306fc1cde5dba4d30c8134778e70ef671c33075e409817ab"));
        ...
        // Testnet Atanapi addresses start with '
        ...
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 5}  };// 5% founder/dev fee forever
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "AZkC7XuQnjH8ikPzEvYdAhXzUHxCVrfdaf");
        ...
        chainTxData = ChainTxData{
            1665648084, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
