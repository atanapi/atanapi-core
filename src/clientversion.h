...
#error Client version information missing: version is not defined by atanapi-config.h or in any other way
#endif
...
/**
 * atanapid-res.rc includes this file, but it cannot cope with real c++ code.
