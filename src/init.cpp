...
public:
    ...
    // Atanapi Specific WalletInitInterface InitCoinJoinSettings
 ...
 * between atanapid, and atanapi-qt and non-server tools.
*/
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-sporkaddr=<atanapiaddress>", "Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.", false, OptionsCategory::DEBUG_TEST);
    ...
    gArgs.AddArg("-platform-user=<user>", "Set the username for the \"platform user\", a restricted user intended to be used by Atanapi Platform, to the specified username.", false, OptionsCategory::SMARTNODE);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Raptor3um/atanapi>";
    const std::string URL_WEBSITE = "<https://atanapi.com>";
...
/** Sanity checks
 *  Ensure that Atanapi Core is running in a usable environment with all
...
bool AppInitMain()
{
    ...
    // ********************************************************* Step 10c: schedule Atanapi-specific tasks
