...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case BTM: return QString("Atanapi");
            case mBTM: return QString("Milli-Atanapi (1 / 1" THIN_SP_UTF8 "000)");
            case uBTM: return QString("Micro-Atanapi (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    ...
    else
    {
        switch(unit)
        {
            case BTM: return QString("TestAtanapis");
            case mBTM: return QString("Milli-TestAtanapi (1 / 1" THIN_SP_UTF8 "000)");
            case uBTM: return QString("Micro-TestAtanapi (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
