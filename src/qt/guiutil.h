...
/** Utility functions used by the Atanapi Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "atanapi:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load atanapi specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a atanapi specific theme is activated (light/dark).*/
