    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  atanapi-qt [command-line options]                     \n";
...
All the Atanapi in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 NAPI, 0.01 NAPI, 0.1 NAPI, 1 NAPI and 10 NAPI -- sort of like the paper money you use every day.</li> \
