...
from test_framework.test_framework import AtanapiTestFramework
...
class LLMQChainLocksTest(AtanapiTestFramework):
    def set_test_params(self):
        self.set_atanapi_test_params(6, 5, fast_dip3_enforcement=True)
