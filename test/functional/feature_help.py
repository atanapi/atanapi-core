...
"""Verify that starting atanapid with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start atanapid with -h for help text")
        ...
        self.log.info("Start atanapid with -version for version information")
